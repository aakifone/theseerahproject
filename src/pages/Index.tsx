    ...
    <div>
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
          <SectionReveal>
            <p className="text-gold-light text-sm font-medium tracking-[0.3em] uppercase mb-6">
              An Interactive Digital Museum
            </p>
          </SectionReveal>
          <SectionReveal delay={100}>
            <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-primary-foreground leading-tight mb-6 text-balance">
              The Life of Prophet
              <br />
              Muhammad <span className="text-gold-light">ﷺ</span>
            </h1>
          </SectionReveal>
          <SectionReveal delay={200}>
            <p className="text-primary-foreground/80 text-lg sm:text-xl leading-relaxed max-w-xl mx-auto mb-10">
          ...
          <SectionReveal delay={300}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/timeline"
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-gold hover:bg-gold-dark text-accent-foreground font-semibold rounded-lg transition-colors text-sm"
              >
                Begin the Journey <ArrowRight className="h-4 w-4" />
              </Link>
              <Link
                to="/sources"
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 border border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 font-medium rounded-lg transition-colors text-sm"
              >
                View Sources
              </Link>
            </div>
          ...
          <SectionReveal>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="text-center p-6 rounded-xl border border-border bg-background hover:shadow-lg transition-shadow"
                >
                  <stat.icon className="h-6 w-6 mx-auto mb-3 text-gold" />
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <SectionReveal>
            <h2 className="font-serif text-3xl font-bold text-center mb-12">Explore the Seerah</h2>
          </SectionReveal>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {ctaLinks.map((cta, i) => (
              <SectionReveal key={cta.to} delay={i * 80}>
                <Link
                  to={cta.to}
                  className="group block p-6 rounded-xl border border-border bg-card hover:border-gold/50 hover:shadow-md transition-all"
                >
      ...
      <section className="py-20 px-4 bg-card geometric-pattern">
        <div className="container mx-auto max-w-4xl">
          <SectionReveal>
            <h2 className="font-serif text-3xl font-bold text-center mb-4">Key Milestones</h2>
            ...
            {milestoneEvents.map((event, i) => (
              <SectionReveal key={event.id} delay={i * 100}>
                <Link
                  ...
                  className="group block p-6 rounded-xl border border-border bg-background hover:border-gold/50 hover:shadow-md transition-all"
                >
                  <div className="flex items-start gap-4">
                    <div className="shrink-0 w-16 text-center">
                      <div className="text-xs font-medium text-gold uppercase tracking-wider">{event.era === "makkan" ? "Makkah" : "Madinah"}</div>
                      <div className="font-serif text-sm font-semibold mt-1">{event.dateRange}</div>
                    </div>
      ...
      <section className="py-24 px-4 text-center">
        <SectionReveal>
          <div className="max-w-2xl mx-auto">
            <p className="text-gold text-sm font-medium tracking-[0.3em] uppercase mb-4">Begin Your Journey</p>
            ...
            <Link
              to="/timeline"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-primary hover:bg-emerald-light text-primary-foreground font-semibold rounded-lg transition-colors text-sm"
            >
