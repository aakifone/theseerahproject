    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 px-4 bg-card geometric-border border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <p className="text-gold text-sm font-medium tracking-[0.3em] uppercase mb-4">Complete Timeline</p>
          <h1 className="font-serif text-4xl sm:text-5xl font-bold mb-4">The Seerah Timeline</h1>
        ...
        <div className="container mx-auto max-w-4xl px-4 py-3">
          ...
          {showFilters && (
            <div className="mt-3 pb-1 space-y-3">
              <div>
                <div className="text-xs text-muted-foreground mb-1.5">Era</div>
              ...
              <div className="flex items-start justify-between gap-3">
                <div>
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    <span className={`text-xs px-2 py-0.5 rounded-full ${eraColors[event.era]}`}>
                      {eraLabels[event.era]}
                    </span>
                    <span className="text-xs text-muted-foreground">{event.dateRange}</span>
                    {event.dateUncertain && (
            ...
            {isExpanded && (
              <div className="px-5 pb-5 border-t border-border pt-4 space-y-4">
                ...
                <div className="p-4 rounded-lg bg-gold/5 border border-gold/20">
                  <h4 className="text-sm font-semibold text-gold-dark mb-1">Why It Matters</h4>
                ...
                {event.reportNotes && (
                  <div className="p-3 rounded-lg bg-muted/50 border border-border">
                    <h4 className="text-xs font-semibold mb-1 text-muted-foreground">Report Notes</h4>
