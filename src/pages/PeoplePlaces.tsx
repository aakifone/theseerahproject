    ...
    <div className="min-h-screen">
      <section className="py-16 px-4 bg-card geometric-border border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-gold text-xs tracking-[0.3em] uppercase mb-4">Glossary</p>
          <h1 className="font-serif text-5xl sm:text-6xl font-bold mb-4 italic">People & Places</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <div className="relative flex-1 max-w-sm">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded border border-border bg-background text-sm outline-none focus:border-primary transition-colors"
              />
            </div>
          </div>
          ...
          {tab === "people" && (
            <div className="grid gap-4">
                    ...
                    <div className="rounded border border-border bg-card p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0">
                          <h3 className="font-serif text-lg font-semibold italic">{person.name}</h3>
                            ...
                            <div className="mt-4 flex flex-wrap gap-2">
                              {relatedEvts.map((evt) => (
                                <Link
                                  ...
                                  className="inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded bg-secondary text-secondary-foreground hover:bg-primary/10 transition-colors"
                                >
              ...
              {filteredPeople.length === 0 && (
                <p className="text-center text-muted-foreground py-8 italic">No people match your search.</p>
              )}
            </div>
          )}
          ...
          {tab === "places" && (
            <div className="grid gap-4 sm:grid-cols-2">
                ...
                <SectionReveal key={place.id} delay={i * 40}>
                  <div className="rounded border border-border bg-card p-6 h-full">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-serif text-lg font-semibold italic">{place.name}</h3>
              ...
              {filteredPlaces.length === 0 && (
                <p className="text-center text-muted-foreground py-8 col-span-2 italic">No places match your search.</p>
              )}
            </div>
          )}
        </div>
